...
- **Try other LLMs.** We prototyped this primarily using gpt-4o-turbo. We would love for others to experiment with other LLMs as well as other hyperparameter choices and see if some do better than others for particular language pairs.
